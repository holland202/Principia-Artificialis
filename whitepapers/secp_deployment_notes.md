> **Archived 2026-07-26.** This was formerly START_HERE.md. It documents SECP
> deployment, not the Principia notes program, and it refers to files that do
> not live in this repo — the paths it names were AI-sandbox outputs. The SECP
> runtime exists on-device at ~/SECP_Runtime and is not yet version-controlled.
> Kept for the deployment steps it records; do not follow its file paths.
